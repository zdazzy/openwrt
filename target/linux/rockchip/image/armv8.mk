...
define Device/xunlong_orangepi-5
 ...
 DEVICE_PACKAGES := \
	...
	kmod-usb-xhci-hcd kmod-usb3 losetup lsblk luci luci-proto-wireguard mkf2fs mount-utils parted partx-util pciutils resize2fs \
	kmod-r8125 usbutils wget-ssl smartmontools luci-app-statistics collectd-mod-cpufreq collectd-mod-sensors collectd-mod-thermal \
	collectd-mod-conntrack collectd-mod-irq dnsmasq-full -dnsmasq ethtool iperf3-ssl bash irqbalance ccrypt cryptsetup cryptsetup-ssh kmod-crypto-user kmod-crypto-xts kmod-hwmon-gpiofan kmod-hwmon-pwmfan kmod-i2c-core kmod-i2c-designware-core kmod-i2c-designware-pci
endef
